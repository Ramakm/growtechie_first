...
const Login = () => {
  ...
  const handleSignUp = async (e) => {
    e.preventDefault();
    if (formData.confirmedPass !== formData.password) {
    ...
    <main>
      <section className="form">
        ...
        >
          ...
          {isSignUp && (
            <>
              <label className="form-control__label">Confirm Password</label>
              <div className="password-field">
                <input
                  type="password"
                  className="form-control"
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, confirmedPass: e.target.value })
                  }
                />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
