    ...
    return (
        <div className="flex flex-col gap-8">
            <Wrapper className="!p-0">
                ...
                <div className="p-6">
                    ...
                    <div className="flex gap-4 mt-2">
                        {teacher.instagram.length > 1 && <a href={teacher.instagram}><InstagramIcon /></a>}
                        {teacher.ytLink.length > 1 && <a href={teacher.ytLink}><YouTubeIcon /></a>}
                        {teacher.twitter.length > 1 && <a href={teacher.twitter}><XIcon /></a>}
                        {teacher.linkedin.length > 1 && <a href={teacher.linkedin}><LinkedInIcon /></a>}
                    </div>
                </div>
            </Wrapper>
            ...
            <Wrapper>
                ...
                <p className="font-light text-[var(--contrast-bg-color)]">{teacher.bio}</p>
            </Wrapper>
            <Wrapper>
