  ...
  return (
    <div className="flex flex-col w-[100vw] mt-20 overflow-hidden min-h-[100vh]">
      <div id="testimonials" className="text-center">
        ...
        <div>
          <div className="my-24 whitespace-nowrap relative flex gap-8">
  ...
  <div className="testimonials-slide flex gap-8">
    {reviews.map((review) => (
      ...
      >
        ...
        <span className="text-sm block text-[var(--dark-gray)]">{review.job}</span>
        <p className="text-sm leading-7 whitespace-normal my-3 font-light opacity-80 text-[var(--primary-text)]">{review.text}</p>
      </div>
    ))}
  </div>
)
