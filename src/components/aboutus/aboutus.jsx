    ...
    <div className="text-[var(--primary-text)] relative mt-10">
      <div>
        <div className="p-5" id="about-us">
          ...
          <p>Join Us on the Digital Learning Journey</p>
        </div>
        <div className="pt-36 mt-10 h-[500px]">
          <div className="relative bg-[var(--moonstone-blue)] h-16 flex justify-center gap-36 items-center w-full">
            {/* Yashodhan */}
            <div>
              <TeamImage
                src={yashodhanImg}
