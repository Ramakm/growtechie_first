        ...
        <div className="flex-col items-center">
          ...
          <div className="w-full flex flex-col xl:flex-row justify-between max-w-screen-xl p-4  bg-opacity-100 rounded-lg shadow-lg hover:shadow-xl transition-transform transform hover:scale-105" style={{ boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.2)' }}>
            <div className="flex justify-around xl:flex-col flex-wrap">
              ...
              <div className="flex flex-col xl:flex-row-reverse xl:h-1/2 xl:gap-8 items-center">
                <div className="mb-6 text-center">
                  <img
                    src="/Yashodhan.png"
                    alt="Yashodhan Gandage"
                    className="w-40 h-40 mx-auto object-cover rounded-full border-4 border-white hover:shadow-xl transition-transform transform hover:scale-105"
                  />
                </div>
                <div className="text-center">
                  <h2 className="text-2xl font-extrabold text-black mb-2">
                  ...
                  <p className="text-sm font-medium text-gray-800">
                    AM (MOJJ)M. Tech, IIT-Kanpur , Ex- GE
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 xl:w-1/2 text-center text-gray-200">
